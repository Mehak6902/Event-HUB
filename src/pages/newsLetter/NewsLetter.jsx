          ...
          <div className="flex flex-col md:flex-row md:gap-6">
            ...
            <div className="mt-5 md:mt-20 lg:mt-10">
              ...
              <p className="text-white text-center px-10 hidden lg:flex">
                {" "}
                Your personal data is to be used by the legal entity EventVibe Hub in order to provide you with the EventVibe Hub services
                that you requested, to send you information on EventVibe Hub
